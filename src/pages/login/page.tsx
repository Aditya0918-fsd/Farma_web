...
export default function LoginPage() {
  ...
  const typeConfig = {
    ...
    admin: { label: "Admin Login", subtitle: "Login as an Admin", icon: Shield },
  };
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div>
                ...
                <div className="relative">
                  ...
                  <Input placeholder="Enter your mobile number" className="pl-10 bg-white/5 border-white/10 text-white placeholder:text-gray-600" />
                </div>
              </div>
              <div>
              ...
              <div>
                <Label className="text-gray-300 text-sm mb-1.5 block">Captcha</Label>
                <div className="flex gap-3">
                  <Input placeholder="Enter captcha" className="bg-white/5 border-white/10 text-white placeholder:text-gray-600" />
                  <div className="flex items-center gap-2 bg-[#1a1a1a] border border-white/10 rounded-lg px-4 font-mono font-bold text-primary tracking-widest text-lg select-none">
                    {captcha}
                    <button type="button" className="cursor-pointer ml-1 text-gray-500 hover:text-primary">
              ...
              <Button type="button" variant="ghost" className="w-full border border-white/10 text-white hover:bg-white/5 py-5">
                Login with WhatsApp
              </Button>
